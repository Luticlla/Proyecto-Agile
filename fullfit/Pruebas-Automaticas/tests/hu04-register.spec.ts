...
test.describe('HU-004: Registro de Datos Personales', () => {
  ...
  test('HU04-CP-01: Formulario de registro carga correctamente', async ({ page }) => {
    await expect(page).toHaveURL('/register')
    await expect(page.locator('text="Crear Cuenta"').first()).toBeVisible()
  })

  test('HU04-CP-02: Campo Nombre obligatorio', async ({ page }) => {
    const nombre = page.locator('#nombre')
    await expect(nombre).toBeVisible()
    expect(await nombre.getAttribute('required')).not.toBeNull()
  })

  test('HU04-CP-03: Campo Apellido obligatorio', async ({ page }) => {
  ...
  test('HU04-CP-04: Campo DNI con pattern numerico de 8 digitos', async ({ page }) => {
  ...
  test('HU04-CP-05: Validacion DNI con menos de 8 digitos', async ({ page }) => {
    const dni = page.locator('#dni')
    await dni.fill('1234')
  ...
  test('HU04-CP-06: Campo Email con validacion type=email', async ({ page }) => {
  ...
  test('HU04-CP-07: Campo Telefono es opcional', async ({ page }) => {
  ...
  test('HU04-CP-08: Campo Telefono tiene placeholder', async ({ page }) => {
    const telefono = page.locator('#telefono, input[name="telefono"]')
    await expect(telefono.first()).toBeVisible()
  ...
  test('HU04-CP-09: Password con menos de 6 caracteres muestra error', async ({ page }) => {
  ...
  test('HU04-CP-10: Contrasenas no coinciden muestra error', async ({ page }) => {
  ...
  test('HU04-CP-11: Spinner carga al enviar formulario', async ({ page }) => {
  ...
  test('HU04-CP-18: Enlace Inicia sesion aqui navega a /login', async ({ page }) => {
  ...
  test('HU04-CP-19: Header tiene enlace Registrarse a /register', async ({ page }) => {
  ...
  test('HU04-CP-20: Campo Genero existe con 3 opciones', async ({ page }) => {
  ...
  test('HU04-CP-22: Campo Fecha Nacimiento existe con date picker', async ({ page }) => {
    const fecha = page.locator('#fecha_nacimiento, input[type="date"], [name="fecha_nacimiento"]')
    await expect(fecha.first()).toBeVisible()
  })

  test('HU04-CP-25: Toggle visibilidad de contrasena', async ({ page }) => {
  ...
  test('HU04-CP-26: Boton deshabilitado mientras envia', async ({ page }) => {
  ...
  test('HU04-CP-27: Error de red signUp manejado', async ({ page }) => {
  ...
  test('HU04-CP-28: DNI con caracteres no numericos bloqueado', async ({ page }) => {
    const dni = page.locator('#dni')
  ...
  test('HU04-CP-29: Contrasena con solo espacios rechazada', async ({ page }) => {
  ...
  test('HU04-CP-30: Telefono solo acepta digitos empieza con 9', async ({ page }) => {
    const telefono = page.locator('#telefono, input[name="telefono"]')
    await expect(telefono.first()).toBeVisible()
  ...
  test('HU04-CP-31: Prevenir doble clic en Crear Cuenta', async ({ page }) => {
    await page.route('**/auth/v1/signup', route => new Promise(() => {}))
    await fillRequiredFields(page)
    const button = page.locator('button[type="submit"]')
    await button.click()
  ...
  test('HU04-CP-32: Foco en primer campo con error al enviar', async ({ page }) => {
    await page.locator('button[type="submit"]').click()
  ...
  test('HU04-CP-33: Campo Genero funcional con 3 opciones', async ({ page }) => {
  ...
  test('HU04-CP-34: Campo Fecha Nacimiento funcional con restricciones', async ({ page }) => {
    const fecha = page.locator('#fecha_nacimiento, input[type="date"], [name="fecha_nacimiento"]')
    await expect(fecha.first()).toBeVisible()
