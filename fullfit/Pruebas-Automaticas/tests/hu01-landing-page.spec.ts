...
test.describe('HU-001: Landing Page Informativa', () => {
  ...
  test('HU01-CP-01: Pagina principal carga correctamente', async ({ page }) => {
    await expect(page).toHaveURL('/')
  })

  test('HU01-CP-02: Banner principal visible con imagen', async ({ page }) => {
    const banner = page.locator('img[alt*="Banner"], section:has(img[alt*="Banner"])')
    await expect(banner.first()).toBeVisible({ timeout: 10000 })
  })

  test('HU01-CP-03: Imagen banner no rota (carga HTTP 200)', async ({ page }) => {
  ...
  test('HU01-CP-04: Texto boton Inscribete ya', async ({ page }) => {
    const btn = page.getByRole('link', { name: /inscríbete/i })
    await expect(btn).toBeVisible()
  })

  test('HU01-CP-05: Enlace boton Inscribete ya navega a /sedes', async ({ page }) => {
    await page.getByRole('link', { name: /inscríbete/i }).click()
    await expect(page).toHaveURL(/sedes/)
  })

  test('HU01-CP-06: Accesibilidad teclado boton Inscribete', async ({ page }) => {
    const btn = page.getByRole('link', { name: /inscríbete/i })
    await btn.focus()
  ...
  test('HU01-CP-11: InfiniteScroll responsivo en movil', async ({ page }) => {
  ...
  test('HU01-CP-12: Carga imagenes faltantes sin romper layout', async ({ page }) => {
  ...
  test('HU01-CP-13: Header con logo y enlaces de navegacion', async ({ page }) => {
  ...
  test('HU01-CP-14: Enlace Sedes en header navega a /sedes', async ({ page }) => {
    await page.getByRole('link', { name: /sedes/i }).first().click()
    await expect(page).toHaveURL(/sedes/)
  })

  test('HU01-CP-15: Enlace Membresias en header navega a /membresias', async ({ page }) => {
    await page.locator('a:has-text("Membresías"), a:has-text("Membresias")').first().click()
    await expect(page).toHaveURL(/membresias/)
  })

  test('HU01-CP-16: Botones auth sin sesion visibles', async ({ page }) => {
  ...
  test('HU01-CP-19: Menu hamburguesa visible en movil', async ({ page }) => {
    await page.setViewportSize({ width: 375, height: 812 })
  ...
  test('HU01-CP-20: Menu horizontal completo en desktop', async ({ page }) => {
  ...
  test('HU01-CP-21: SideMenu se abre al pulsar hamburguesa', async ({ page }) => {
    await page.setViewportSize({ width: 375, height: 812 })
    await page.waitForTimeout(300)
  ...
  test('HU01-CP-22: SideMenu se cierra al hacer click en overlay', async ({ page }) => {
    await page.setViewportSize({ width: 375, height: 812 })
    await page.waitForTimeout(300)
  ...
  test('HU01-CP-23: Navegacion desde SideMenu funciona', async ({ page }) => {
    await page.setViewportSize({ width: 375, height: 812 })
    await page.waitForTimeout(300)
    const hamburger = page.locator('.hamburger-react, button:has(svg)').first()
    await expect(hamburger).toBeVisible({ timeout: 5000 })
  ...
  test('HU01-CP-24: Redes sociales en footer', async ({ page }) => {
  ...
  test('HU01-CP-25: Redes sociales se abren en nueva pestana', async ({ page }) => {
  ...
  test('HU01-CP-27: Logo centrado en footer', async ({ page }) => {
    const footer = page.getByRole('contentinfo').first()
    await expect(footer).toBeVisible()
  ...
  test('HU01-CP-28: Copyright con ano actual', async ({ page }) => {
    const footer = page.getByRole('contentinfo').first()
    await expect(footer).toBeVisible()
  ...
  test('HU01-CP-29: Fondo negro y acento amarillo', async ({ page }) => {
  ...
  test('HU01-CP-30: Fuentes JetBrains Mono y Press Start 2P', async ({ page }) => {
  ...
  test('HU01-CP-31: Sin scroll horizontal', async ({ page }) => {
  ...
  test('HU01-CP-32: Sin errores criticos en consola', async ({ page }) => {
    const errors: string[] = []
  ...
  test('HU01-CP-33: Meta tags SEO presentes', async ({ page }) => {
  ...
  test('HU01-CP-36: Pagina 404 para rutas inexistentes', async ({ page }) => {
  ...
  test('HU01-CP-38: Header sticky al hacer scroll', async ({ page }) => {
  ...
  test('HU01-CP-42: Footer responsivo en diferentes resoluciones', async ({ page }) => {
  ...
  test('HU01-CP-43: Orden de foco Tab es logico', async ({ page }) => {
