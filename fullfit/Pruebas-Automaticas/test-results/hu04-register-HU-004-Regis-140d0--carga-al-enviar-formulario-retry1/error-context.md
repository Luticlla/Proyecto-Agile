...
- Name: hu04-register.spec.ts >> HU-004: Registro de Datos Personales >> CP-11: Spinner carga al enviar formulario
- Location: tests/hu04-register.spec.ts:130:7
      ...
      - generic [ref=e12]:
        - generic [ref=e13]:
          ...
          - generic [ref=e37]:
            ...
            - textbox "Confirmar Contraseña *" [active] [ref=e38]:
              - /placeholder: ••••••••
              - text: test1234
          - paragraph [ref=e39]: "Para activar el registro: valida tu DNI con RENIEC, completa todos los campos y asegúrate de que las contraseñas coincidan."
          - button "Crear Cuenta" [disabled]
        - generic [ref=e40]:
          - text: ¿Ya tienes cuenta?
          - link "Inicia sesión aquí" [ref=e41] [cursor=pointer]:
            - /url: /login
