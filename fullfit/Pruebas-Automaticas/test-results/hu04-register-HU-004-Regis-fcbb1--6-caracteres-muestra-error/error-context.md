...
- Name: hu04-register.spec.ts >> HU-004: Registro de Datos Personales >> CP-09: Password con menos de 6 caracteres muestra error
- Location: tests/hu04-register.spec.ts:114:7
        ...
        - generic [ref=e13]:
          ...
          - generic [ref=e42]:
            ...
            - textbox "Confirmar Contraseña *" [active] [ref=e43]:
              - /placeholder: ••••••••
              - text: "123"
          - paragraph [ref=e44]: "Para activar el registro: valida tu DNI con RENIEC, completa todos los campos y asegúrate de que las contraseñas coincidan."
          - button "Crear Cuenta" [disabled]
        - generic [ref=e45]:
          - text: ¿Ya tienes cuenta?
          - link "Inicia sesión aquí" [ref=e46] [cursor=pointer]:
            - /url: /login
...
```ts
  16  |   await page.locator('#password').fill(pwd)
  17  |   await page.locator('#confirmPassword').fill(conf)
  18  | }
  19  |  
  20  | /**
  21  |  * Completa el formulario de forma válida de extremo a extremo:
  22  |  * mockea RENIEC, hace clic en "Validar" (lo cual habilita el resto del
  23  |  * formulario y desbloquea el botón "Crear Cuenta"), y llena los campos
