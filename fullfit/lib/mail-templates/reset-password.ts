export function getResetPasswordEmail(userName: string, resetUrl: string) {
  ...
  return `
    ...
    <head>
      ...
      <title>Restablecer Contraseña - FULLFORMA</title>
    </head>
                    ...
                    <tr>
                      <td style="padding:16px;">
                        <p style="color:#71717a; font-size:12px; line-height:1.5; margin:0;">
                          ⏱️ Este enlace expira en <strong style="color:#a1a1aa;">1 hora</strong>.
                        </p>
