export function getMembresiaPorVencerEmail(
  userName: string,
  planNombre: string,
  fechaFin: string,
  ...
  return `
    ...
    <head>
      ...
      <title>Tu membresía está por vencer - FULLFORMA</title>
    </head>
              ...
              <tr>
                <td style="padding:40px;">
                  ...
                  <p style="color:#a1a1aa; font-size:14px; line-height:1.6; margin:0 0 8px 0;">
                    Tu membresía <strong style="color:#fafafa;">${planNombre}</strong> está próxima a vencer.
                  </p>
                  <p style="color:#a1a1aa; font-size:14px; line-height:1.6; margin:0 0 24px 0;">
                    Fecha de vencimiento: <strong style="color:#facc15;">${fechaFormateada}</strong>
                  </p>
                  <!-- Info card -->
                  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0f0f11; border-radius:8px; border:1px solid #27272a;">
                    <tr>
                      <td align="center" style="padding:20px;">
                        <p style="color:#facc15; font-size:32px; font-weight:800; margin:0 0 4px 0;">${diasRestantes}</p>
                        <p style="color:#71717a; font-size:13px; margin:0;">días restantes</p>
                      </td>
                    </tr>
                  </table>
                  <!-- Botón -->
                  ...
                  <p style="color:#71717a; font-size:12px; line-height:1.5; margin:16px 0 0 0; text-align:center;">
                    Si no realizas la renovación, tu membresía se desactivará automáticamente.
                  </p>
                </td>
              </tr>
              <!-- Footer -->
